        ...
        <div class="p-6 bg-white border-b border-gray-200">
          ...
          <form method="post" action="{{ route('owner.products.update', ['product' => $product->id ])}}">
            ...
            <div class="-m-2">
              ...
              <div class="p-2 w-1/2 mx-auto">
                <div class="relative">
                  <label for="sort_id" class="leading-7 text-sm text-gray-600">販売する店舗</label>
              ...
              <x-select-image :images="$images" currentId="{{ $product->image5 }}" name="image5" />
              <div class="p-2 w-1/2 mx-auto">
                <div class="relative flex justify-around">
          ...
          <form id="delete_{{$product->id}}" method="post" action="{{ route('owner.products.destroy', ['product' => $product->id]) }}">
            ...
            <div class="p-2 w-full flex justify-around mt-32">
              <a href="#" date-id="{{$product->id}}" onclick="deletePost(this)" class="text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-indigo-500 rounded">削除する</a>
            </div>
          </form>
        </div>
      </div>
